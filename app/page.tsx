...
const brands: Brand[] = [
  ...
  },
  {
    ...
    iconBg: "#e8f0f8",
    brochures: [
      { label: "CN7", file: "/hyundai/brochures/cn7.pdf" },
      { label: "DN8 N-Line", file: "/hyundai/brochures/dn8-n-line.pdf" },
      ...
      { label: "Santa Fe TM", file: "/hyundai/brochures/santa-fe-tm.pdf" },
