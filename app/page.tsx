...
const brands: Brand[] = [
  ...
  },
  {
    id: "ev3",
    brand: "CSM EV3",
    priceFile: "/csm/ev3-pricelist.pdf",
    color: "#16a34a",
    stripColor: "#16a34a",
    iconBg: "#f0fdf4",
    brochures: [
      { label: "EV3 Brochure", file: "/csm/CSM-EV3-Brochure.pdf" },
    ],
    emiPlans: [],
  },
  {
    ...
    iconBg: "#e8f0f8",
    brochures: [
      { label: "CN7", file: "/hyundai/brochures/CN7-Brochure.pdf" },
      { label: "DN8 N-Line", file: "/hyundai/brochures/DN8-N-Line-Brochure.pdf" },
      { label: "Elantra 1.6 SP", file: "/hyundai/brochures/Hyundai-Elantra-1.6-SP-Leaflet.pdf" },
      { label: "PALISADE 2026", file: "/hyundai/brochures/Hyundai-PALISADE-2026.pdf" },
      { label: "Porter", file: "/hyundai/brochures/Porter-Leaflet-Mar-23.pdf" },
      { label: "Santa Fe TM", file: "/hyundai/brochures/Santa-Fe-TM-Brochure.pdf" },
      { label: "Sonata 2.0", file: "/hyundai/brochures/Sonata-2.0.pdf" },
    ],
    emiPlans: [
      { label: "Elantra Hybrid", sub: "18 months · 40% down", file: "/hyundai/emi-plans/hyundai-emi-elantra-hybrid-18m.pdf" },
      { label: "Elantra Hybrid", sub: "24 months · 60% down", file: "/hyundai/emi-plans/hyundai-emi-elantra-hybrid-24m.pdf" },
      { label: "Tucson FWD", sub: "18 & 24 months · 50% down", file: "/hyundai/emi-plans/hyundai-emi-tucson-fwd.pdf" },
      { label: "Tucson AWD", sub: "18 months · 50% down", file: "/hyundai/emi-plans/hyundai-emi-tucson-awd.pdf" },
      { label: "Santa Fe FWD", sub: "18 months · 45% down", file: "/hyundai/emi-plans/hyundai-emi-santa-fe-fwd.pdf" },
      { label: "Santa Fe AWD", sub: "18 & 24 months · 45% down", file: "/hyundai/emi-plans/hyundai-emi-santa-fe-awd.pdf" },
    ],
  },
  {
    id: "jetour",
